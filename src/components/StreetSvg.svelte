...
<div class:visible={step >= 0 && step < 3} id="madera-wrapper">
  ...
  <div class="img-wrapper">
    <img src="assets/img/1_mapa_antigo_sem_fundo.png" alt="street grid lines of madera, ca." />
  </div>
</div>
<div class:visible={step > 2 && step < 6} id="gardena-wrapper">
  <!-- <div class="svg-wrapper">{@html gardena}</div> -->
  <div class="img-wrapper">
    <img src="assets/img/2_mapa_cidade_sem_fundo.png" alt="street grid lines of gardena, ca." />
  </div>
</div>
<div class:visible={step >= 6} id="fremont-wrapper">
  <!-- <div class="svg-wrapper">{@html fremont}</div> -->
  <div class="img-wrapper">
    <img src="assets/img/3_mapa_centro_sem_fundo.png" alt="street grid lines of fremont, ca." />
  </div>
</div>
